    ...
    <Box sx={{ maxWidth: { md: 360 }, textAlign: { xs: 'center', md: 'unset' } }}>
      ...
      <m.div variants={varFade('inUp')}>
        <Typography sx={{ color: 'common.white' }}>
          Mục tiêu của chúng tôi là mang đến khóa học và dịch vụ khiến bạn hài lòng, gắn bó mỗi
          ngày. Vì vậy, chúng tôi luôn nỗ lực cải thiện chương trình học, lắng nghe góp ý từ học
          viên và không ngừng hoàn thiện để mang lại trải nghiệm tốt nhất.
        </Typography>
      </m.div>
